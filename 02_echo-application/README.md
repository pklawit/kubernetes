...
```bash
echo "Hi, this is message from client POD!" | nc -N echo-service 8080
```
...
<pre>Log: [Pod IP: 10.42.0.30] [Time:2026-06-10 04:47:21]: Hi, this is message from client POD!</pre>
